...
def main(page: ft.Page):
    ...
    favourite_names = []
    favourite_text = ft.Text(value='Любимые имена:')
    ...
    def add_favorite_name(_):
        if greeting_history:
            ...
            favourite_names.append(last_name)
            favourite_text.value = 'Любимые имена:\n'+ '\n'.join(favourite_names)
            page.update()
    ...
    page.add(view_greeting_text, ft.Row([name_input, button_elevated, clear_button]), history_text, favourite_text)
